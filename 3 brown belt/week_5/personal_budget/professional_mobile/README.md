Реализуйте расширенный функционал из предыдущей задачи (professional desktop version) в более жёстких ограничениях: теперь за 5,75 секунд необходимо обрабатывать до 100000 запросов.
